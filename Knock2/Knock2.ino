/*
   Code for DIY Knock
   Customized for personal use by Vatsal Hariramani
...
void Knock1_Action(String Event_name)
{
  ...
  digitalWrite(Green, HIGH);
    ...
    http.begin("http://192.168.1.150/?socket=1On"); //HTTP
...
void Knock2_Action(String Event_name)
{
  digitalWrite(Green, HIGH);
    ...
    // configure traged server and url
    //http.begin("https://192.168.1.12/test.html", "7a 9c f4 db 40 d3 62 5a 6e 21 bc 5c cc 66 c8 3e a1 45 59 38"); //HTTPS
    http.begin("http://192.168.1.150/?socket=1Off"); //HTTP
...
void Knock3_Action(String Event_name)
{
  digitalWrite(Green, HIGH);
    ...
    // configure traged server and url
    //http.begin("https://192.168.1.12/test.html", "7a 9c f4 db 40 d3 62 5a 6e 21 bc 5c cc 66 c8 3e a1 45 59 38"); //HTTPS
    http.begin("http://maker.ifttt.com/trigger/play_music/with/key/" + Webhooks_key); //HTTP
...
void Knock4_Action(String Event_name)
{
  digitalWrite(Green, HIGH);
    ...
    // configure traged server and url
    //http.begin("https://192.168.1.12/test.html", "7a 9c f4 db 40 d3 62 5a 6e 21 bc 5c cc 66 c8 3e a1 45 59 38"); //HTTPS
    http.begin("http://maker.ifttt.com/trigger/find_phone/with/key/" + Webhooks_key); //HTTP
...
void Knock5_Action(String Event_name)
{
  ...
  digitalWrite(Green, HIGH);
    ...
    // configure traged server and url
    //http.begin("https://192.168.1.12/test.html", "7a 9c f4 db 40 d3 62 5a 6e 21 bc 5c cc 66 c8 3e a1 45 59 38"); //HTTPS
    http.begin("http://maker.ifttt.com/trigger/send_message/with/key/" + Webhooks_key); //HTTP
    Serial.print("[HTTP] GET...\n");
    // start connection and send HTTP header
    int httpCode = http.GET();
